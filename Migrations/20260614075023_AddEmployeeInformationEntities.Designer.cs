...
namespace api_hrm.Migrations
{
    ...
    [Migration("20260614075023_AddEmployeeInformationEntities")]
    partial class AddEmployeeInformationEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiHrm.Domains.Entities.EmergencyContact", b =>
                {
                    b.HasOne("ApiHrm.Domains.Entities.Employee", "Employee")
                        ...
                        .HasForeignKey("ApiHrm.Domains.Entities.EmergencyContact", "Employee_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
